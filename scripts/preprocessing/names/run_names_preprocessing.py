...
@click.option('--input_file', '-i',
              default='C:/Users/kater/PycharmProjects/ProductMapping/data/source/100_products/names/100_products.txt',
              required=False,
              help='Input file with product names dictionary file to preprocess')
@click.option('--output_file', '-o',
              default='C:/Users/kater/PycharmProjects/ProductMapping/data/preprocessed/100_products/names/100_products_prepro.txt',

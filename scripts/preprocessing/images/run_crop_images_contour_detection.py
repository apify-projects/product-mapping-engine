...
@click.option('--input_file', '-i',
              default='C:/Users/kater/PycharmProjects/ProductMapping/data/source/10_products/images',
              required=False,
              help='Folder with input images to be cropped')
@click.option('--output_file', '-o',
              default='C:/Users/kater/PycharmProjects/ProductMapping/data/preprocessed/10_products/images/cropped_masked',

...
async def main():
    async with Actor() as actor:
        ...
        if 'ACTOR_MAX_PAID_DATASET_ITEMS' in os.environ and os.environ['ACTOR_MAX_PAID_DATASET_ITEMS'] != "" and int(os.environ['ACTOR_MAX_PAID_DATASET_ITEMS']) != 0:
            max_items_to_process = int(os.environ['ACTOR_MAX_PAID_DATASET_ITEMS'])

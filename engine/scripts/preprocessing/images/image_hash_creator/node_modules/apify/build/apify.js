...
class Apify {
    ...
    main(userFunc) {
        ...
        try {
            events_1.initializeEvents(this.config);
            return (async () => {
                try {
                    await userFunc();
    ...
    async metamorph(targetActorId, input, options = {}) {
        ...
        await utils_1.sleep(customAfterSleepMillis || this.config.get('metamorphAfterSleepMillis'));
    }
    /**
     *
    ...
    async openRequestList(listName, sources, options = {}) {
        ...
        ow_1.default(options, ow_1.default.object.is((v) => !Array.isArray(v)));
    ...
    async openSessionPool(sessionPoolOptions) {
        const sessionPool = new session_pool_1.SessionPool(sessionPoolOptions);

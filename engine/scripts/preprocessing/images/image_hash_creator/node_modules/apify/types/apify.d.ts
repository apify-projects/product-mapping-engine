...
export class Apify {
    ...
    get utils(): {
        ...
        playwright: {
            gotoExtended: (page: import("playwright").Page, request: import("./request").default, gotoOptions?: import("./playwright_utils").DirectNavigationOptions | undefined) => Promise<import("playwright").Response | null>;
        };
        social: {

...
export class StorageManager<T> {
     ...
     */
    constructor(StorageConstructor: T, config?: Configuration | undefined);
    StorageConstructor: T;
    name: any;
    cache: import("@apify/datastructures").LruCache<any>;
     ...
     * @return {Promise<T>}
     */
    openStorage(idOrName?: string | undefined, options?: {
     ...
     * @internal
     */
    protected _getOrCreateStorage(storageIdOrName: string, storageConstructorName: string, apiClient: any | ApifyStorageLocal): Promise<any>;
    /**
     ...
     * @internal
     */
    protected _getStorageClientFactories(client: any | ApifyStorageLocal, storageConstructorName: string): {

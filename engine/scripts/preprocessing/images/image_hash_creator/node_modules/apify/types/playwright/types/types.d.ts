...
declare module 'playwright/types/types' {
    ...
    import { Serializable, EvaluationArgument, PageFunction, PageFunctionOn, SmartHandle, ElementHandleForTag, BindingSource } from 'playwright/types/structs';
    ...
    export interface Page {
       ...
       * await page.addInitScript({ path: 'playwright/types/preload.js' });
       * ```
       * 
